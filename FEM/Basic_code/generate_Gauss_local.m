function [Gauss_coefficient_local_1D,Gauss_point_local_1D]=generate_Gauss_local(Gauss_coefficient_reference_1D,Gauss_point_reference_1D,lower_bound,upper_bound)
